 ...
 * advisory `$suggest`ion, whether it is `$required`, and whether only a #311-`$verified` answer will
 ...
 *
 * `$verified` is accepted only where it can be honoured (#498 §3.1b): on the OIDC flow, and only for
 * a type #311 can attest (v1: `email`). Sending it on a `one_time` request is refused with
