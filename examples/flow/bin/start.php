...
/**
 * One-command launcher for the flow example (spec §2, §3; plan Phase 2).
 *
 * Steps:
...
const CONTRACT_VERSION = 2; // must equal Server::CONTRACT_VERSION (flow family = v2)
const RELEASE_BASE = 'https://github.com/allme-sdk/example-test-suite/releases/download';

$base = dirname(__DIR__);
chdir($base);

fwrite(STDERR, "flow example — starting up\n");
